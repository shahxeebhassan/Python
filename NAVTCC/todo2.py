...
class TaskManager(tk.Frame):
    def __init__(self, master):
        ...
        self.add_task_button = tk.Button(self, text="Add Task", font=('Arial', 12), command=self.add_task, bg="#4CAF50", fg="white")
        self.remove_task_button = tk.Button(self, text="Remove Task", font=('Arial', 12), command=self.remove_task, bg="#FF5722", fg="white")
        self.show_all_tasks_button = tk.Button(self, text="Show All Tasks", font=('Arial', 12), command=self.show_all_tasks, bg="#2196F3", fg="white")
